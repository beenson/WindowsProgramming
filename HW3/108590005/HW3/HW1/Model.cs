...
namespace homework1
{
    public class Model
    {
        ...
        public Model()
        {
            ...
            {
                _courses.AddRange(GetCourses(code));
            }
        }
        ...
        // 取得course
        private List<Course> GetCourses(string code)
        {
            ...
            {
                courses.Add(new Course(department, nodeTableRow[i].ChildNodes));
            }
            return courses;
        }
        ...
        // 邊更課程資訊
        public void ChangeCourseInfo(Course course, Course editedCourse)
        {
            course.SetValueAs(editedCourse);
            NotifySelectedCourseChanged();
        }
