...
namespace homework1
{
    public class StartUpFormPresentationModel
    {
        ...
        // 創建 CourseManagementFormPresentationModel
        public CourseManagementFormPresentationModel GetCourseManagementPresentationModel()
        {
            return new CourseManagementFormPresentationModel(_model);
        }
    }
}
