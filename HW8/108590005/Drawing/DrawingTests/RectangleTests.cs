...
namespace DrawingModel.Tests
{
    ...
    public class RectangleTests
    {
        ...
        {
            Assert.AreEqual("Rectangle(5, 15, 10, 20)", A.ToString());
            Assert.AreEqual("Rectangle(20, 30, 30, 40)", B.ToString());
            Assert.AreEqual("Rectangle(40, 40, 50, 50)", C.ToString());
            Assert.AreEqual("Rectangle(25, 10, 50, 30)", D.ToString());
        }
        ...
        {
            Assert.IsTrue(A.IsPointInShape(new Point(5, 15)));
            Assert.IsTrue(A.IsPointInShape(new Point(5, 20)));
            Assert.IsTrue(A.IsPointInShape(new Point(10, 15)));
            Assert.IsTrue(A.IsPointInShape(new Point(10, 20)));
            Assert.IsFalse(A.IsPointInShape(new Point(4, 15)));
            Assert.IsFalse(A.IsPointInShape(new Point(4, 20)));
            Assert.IsFalse(A.IsPointInShape(new Point(5, 14)));
            Assert.IsFalse(A.IsPointInShape(new Point(5, 21)));
            Assert.IsFalse(A.IsPointInShape(new Point(10, 14)));
            Assert.IsFalse(A.IsPointInShape(new Point(10, 21)));
            Assert.IsFalse(A.IsPointInShape(new Point(11, 15)));
            Assert.IsFalse(A.IsPointInShape(new Point(11, 20)));
        }
        ...
        {
            A.MoveTo(new Point(50, 50));
            Assert.AreEqual(new Point(50, 50), A.UpperLeft);
            Assert.AreEqual(5, A.Width);
            Assert.AreEqual(5, A.Height);
        }
    }
